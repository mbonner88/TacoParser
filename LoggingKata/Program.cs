...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if(lines.Length == 0)
            {
                logger.LogError("file has no lines of input");
            }
            if(lines.Length == 1)
            {
            ...
            logger.LogInfo($"Greatest distance found between {tacoBell1.Name} at {tacoBell1.Coords()}, and {tacoBell2.Name} at {tacoBell2.Coords()}");
